...
class Main(CLI):
    def __init__(self):
        ...
        parser.add_argument('-v', '--verbose', dest='verbose', action='store_true', default=False, help="Informational messages.")
        parser.add_argument('-vv', '--super-verbose', dest='super_verbose', action='store_true', default=False, help="Debug messages.")
